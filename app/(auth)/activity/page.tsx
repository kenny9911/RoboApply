...
// /activity — Activity log (V3 Route 9).
//
...
// (stub today). The shell (Sidebar + Topbar + .main-inner wrapper) is provided
// by (auth)/layout.tsx — this page renders the inner content only.
