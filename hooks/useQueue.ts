...
// through `raV2Api.queue.*` so they hit the in-memory stub today and the real
// backend after the Wave-4 swap. Query keys are namespaced `['v3', 'queue', …]`.
//
// Surface:
...
export function useQueue(): UseQueryResult<QueueListResponse, Error> {
